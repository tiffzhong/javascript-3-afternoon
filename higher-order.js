...
let orderTotals = orders.map(function(total, i) {
  return total = (orders[i].price * (1 + orders[i].tax));
})
...
{"owner":"Barry","price":129},{"owner":"Barry","price":38},
...
let bobsTotal = 
  ...
  .reduce((val, amount) => val + amount.price, 0);